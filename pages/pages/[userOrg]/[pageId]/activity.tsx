...
const ActivityPage: WithPageLayout<ActivityPageProps> = ({ insight, ogImage }: ActivityPageProps) => {
  ...
  useEffect(() => {
    ...
    captureAnalytics({ title: "Insights Display", property: "tools", value: `Activity selected`, userInfo });
  }, [userInfo, isLoading]);
...
ActivityPage.PageLayout = HubPageLayout;
