...
export interface updateUserPayload {
  name?: string; email?: string; bio?: string; url?: string; twitter_username?: string; company?: string; location?: string; interests?: string[]; display_local_time?: boolean; timezone?: string;
}
