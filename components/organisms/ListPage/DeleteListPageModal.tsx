    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="grid grid-cols-1 gap-4 p-4 max-w-[90%] lg:max-w-xl rounded-t-lg">
        ...
        <Text>
          ...
          <span className="font-bold text-light-slate-12 dark:text-dark-slate-12">{listName}</span>? If you have data on
          this list that your team is using, they will lose access.
        </Text>
        <Text className="font-bold text-light-slate-12 dark:text-dark-slate-12">This action cannot be undone</Text>
        <Text>
