    ...
    <div className="w-full relative  bg-light-slate-6 h-[216px]">
      ...
      <div className="w-full absolute -top-6 px-6 md:px-12 lg:px-16 flex flex-row items-end justify-between py-6">
        <div className="translate-y-[75px]">
          <Avatar className="u-photo" alt={`user image of${githubName}`} hasBorder avatarURL={avatarUrl} size={184} isCircle />
        </div>
        {isConnected && (
          <div className="flex gap-3 flex-col md:flex-row items-center">
            <a target="_blank" rel="noopener noreferrer" href={`https://github.com/${githubName}`} className="u-url">
