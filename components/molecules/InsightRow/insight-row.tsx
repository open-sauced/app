...
const InsightRow = ({ user, insight }: InsightRowProps) => {
  ...
  return (
    <Link
      ...
      passHref
    >
      <a className="flex w-full rounded-lg px-8 py-5 gap-2 bg-white items-center">
        ...
        <div className="flex-1 ">
          <div className="flex items-center gap-8 w-full">
            ...
            <div className="flex flex-col gap-2 min-w-[120px] flex-1">
              ...
              <div
                className="flex text-light-grass-10 items-end gap-6
            "
              >
                <Text className="!text-2xl !text-black !leading-none">{`${open} PR${open > 1 ? "s" : ""}`}</Text>
            ...
            <div className="flex-1 gap-2 flex flex-col  min-w-[150px]">
              ...
              <div className="flex text-light-grass-10 items-end gap-6">
                <Text className="!text-2xl !tracking-widest !text-black !leading-none">
                  {repoData.length > 0 ? getRelativeDays(Math.round(velocity / repoData.length)) : "-"}
                </Text>
