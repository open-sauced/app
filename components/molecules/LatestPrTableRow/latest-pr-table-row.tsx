...
const LatestPrTableRow = ({
  ...
  return (
    <a href={`https://github.com/${repoOwner}/${repoName}/pull/${prNumber}`} className="!cursor-pointer" target="_blank" rel="noreferrer">
      <div className="flex gap-2 items-center px-2 py-1">
        <div className={`flex cursor-pointer item-center gap-2 w-3/5 ${isHoverCard && "w-5/6"}`}>
          {prStatus === "open" ? (
