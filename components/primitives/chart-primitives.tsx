...
>(({ className, hideIcon = false, payload, verticalAlign = "bottom", nameKey }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={clsx("flex items-center justify-center gap-4", verticalAlign === "top" ? "pb-3" : "pt-3", className)}
    >
      {payload.map((item) => {
        ...
        return (
          <div
            key={item.value}
            className={clsx("flex items-center gap-1.5 [&>svg]:h-3 [&>svg]:w-3 [&>svg]:text-muted-foreground")}
          >
