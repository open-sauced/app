...
const ContextFilterOption: React.FC<ContextFilterOptionProps> = ({ children, isSelected, onClick }) => {
  return (
    <button
      ...
      } flex w-full px-2 py-1.5  text-sm text-slate-600 font-medium whitespace-nowrap rounded-md      hover:bg-light-orange-3 hover:text-slate-800 focus:outline-none focus-visible:border-orange-500 focus-visible:ring focus-visible:ring-orange-200 transition`}
    >
