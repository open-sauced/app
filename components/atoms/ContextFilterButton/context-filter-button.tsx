...
const ContextFilterButton: React.FC<ContextFilterButtonProps> = ({ className, children, onClick, isSelected }) => {
  return (
    <button
      onClick={onClick}
      className="flex w-full items-center gap-1 py-1 px-2 bg-slate-100 border border-slate-300 text-sm text-slate-800   whitespace-nowrap rounded-md drop-shadow-sm hover:bg-slate-50 transition"
    >
