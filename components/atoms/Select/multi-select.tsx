...
const MultiSelect = ({
  ...
  return (
    <Popover open={open} onOpenChange={(value) => setOpen(value)}>
      <PopoverPrimitive.Anchor className={clsx("w-full")}>
        <div className="min-w-[250px] w-full">
          <PopoverTrigger
            asChild
            className="!px-3 h-[2.1rem] py-1  border rounded-md bg-white data-[state=open]:border-orange-500  min-w-[250px] w-full"
          >
            <button
          ...
          <PopoverContent sideOffset={5} className={clsx("popover-width bg-white-400", className)}>
