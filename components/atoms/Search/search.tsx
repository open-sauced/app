...
const Search = ({ placeholder, name, value , autoFocus}: SearchProps): JSX.Element => {
  return (
    <div className="flex bg-white  py-1 w-max px-3 shadow-input border transition focus-within:ring focus-within:border-orange-500 focus-within:ring-orange-100 rounded-lg   ring-light-slate-6 items-center">
